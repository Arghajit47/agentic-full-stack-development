  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        description:
          "Stay informed with clear and timely financial reporting for your property.",
        icon: Wallet,
      },
      {
        title: "Legal Compliance",
        description:
          "Navigate property regulations with confidence. We ensure your property meets all legal requirements.",
        icon: Scale,
      },
    ],
    ctaHeading: "Experience Hassle-Free Property Management",
    ctaBody:
      "Ready to enjoy hassle-free property management? Explore our Property Management Service categories and let us take care of the rest.",
