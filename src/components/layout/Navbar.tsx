...
export function Navbar() {
  ...
  return (
    <div className="w-full" data-testid="navbar">
      {/* Top banner */}
      <div
        className="w-full border-b border-zinc-800/60 bg-zinc-950 px-4 py-2.5 text-center text-xs text-zinc-400 sm:px-6 lg:px-8"
        style={{ backgroundImage: "url('/images/abstract-design.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}
      >
        {isLoading ? (
          <BannerSkeleton />
        ) : error ? (
